            ...
            <div>
                ...
                <Container>
                    <Row>
                        <Col>
                            <Card style={{ width: "20rem" }} data-aos="fade-up">
                                <Card.Img variant="top" src={tanmayee} className="fixed-size-img" />
                                <Card.Body>
                    ...
                    <Row>
                        <Col>
                            <Card style={{ width: "20rem" }} data-aos="fade-up">
                                <Card.Img variant="top" src={krishna} className="fixed-size-img" />
                                <Card.Body>
                                    <Card.Title>Krishna Teja Rangavajjala</Card.Title>
                                    <Card.Text>
                                        Pursuing a master’s degree in Computer Science. I completed my undergraduate studies in Information Technology at CVR College of Engineering. 
                                        After finishing my undergraduate program, I directly started my master’s program. I have a strong understanding of Java, HTML, CSS, JavaScript, 
                                        basic React, basic Spring, JDBC, SQL, Python, and machine learning. During my undergraduate studies, 
                                        I worked on two projects: a movie recommendation system using Python, and a project that predicted hotel booking 
